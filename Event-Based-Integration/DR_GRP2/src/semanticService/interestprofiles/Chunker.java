...
/**
	...
	// Sollte es mehrmals den gleichen Chunk geben, wird dieser �berschrieben und es wird nur einmal dieser chunk ausgegeben
	//das ist aber nicht weiter schlimm, da f�r den einen chunk immer die gleichen Semantiken niedergelegt sind
	/**
