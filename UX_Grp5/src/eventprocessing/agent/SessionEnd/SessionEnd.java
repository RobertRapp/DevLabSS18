 ...
 *
 */
public class SessionEnd extends AbstractAgent {

	private static final long serialVersionUID = 5361140545621342113L;

	@Override
	protected void doOnInit() {
		this.setId("SessionEndAgent");
		/*
		...
		try {
			...
			ip.add(new IsEventType(GUIValues.INSTANCE.getSessionEndEvent()));
		 ...
		 */
		try {
			this.add(GUIValues.INSTANCE.getSessionEndTopic());
		} catch (NoValidConsumingTopicException e) {
			e.printStackTrace();
		}
